...
const EditStaffModalFormComponent = ({
    ...
    return (
        <ModalUI
            ...
            title="Edit Staff"
            footer={() => (
                <SubmitBtn loadingIndicator={isLoading} btnText={'Update Staff'} className="cursor-pointer bg-blue-400" onClick={onSubmit} />
            )}
        >
...
export default EditStaffModalFormComponent;
