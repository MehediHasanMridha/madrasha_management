            ...
            <FieldSet label={'Academic information'} labelClassName="text-[16px] font-bold" hr={true}>
                <Field label={'Joining Class'} error={errors.joining_class}>
                    <select
                        ...
                        onChange={(e) => {
                            const selectedClass = department.classes.find((classItem) => String(classItem.id) === e.target.value);
                            if (selectedClass) setFees(selectedClass.fee_types);
                            register('joining_class').onChange(e);
                        }}
                    >
