...
const AddStudentWithFeePrintableComponent = ({ data, printComponentRef, printFn, loading, month, handleClose, admission_fee }) => {
    return (
        <div className="flex h-full flex-col space-y-4 px-2">
            {/* Printable Receipt Content */}
            <AdmissionFeePrintReceiptComponent ref={printComponentRef} data={data} month={month} admissionFee={admission_fee} />
