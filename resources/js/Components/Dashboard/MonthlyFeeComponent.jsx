        ...
        <div className="rounded-[8px] bg-white p-[24px]">
            ...
            <div className="">
                <div className="flex items-end justify-start gap-1.5 py-[16px]">
                    <div className="text-[32px] leading-9 font-medium text-[#131313]">{formattedAmount(data?.monthly_income)}</div>
                    <div className="text-base font-normal text-[#afafaf]">/{formattedAmount(data?.total_tk)} BDT</div>
                </div>
                ...
                <div className="flex h-[18px] items-center justify-start gap-4">
                    <div className="text-xs font-normal text-[#4a4a4a]">{formattedAmount(data?.monthly_income)} BDT</div>
                    ...
                    <div className="text-xs font-normal text-[#4a4a4a]">{formattedAmount(data?.total_tk - data?.monthly_income)} BDT</div>
                </div>
            </div>
        </div>
    );
