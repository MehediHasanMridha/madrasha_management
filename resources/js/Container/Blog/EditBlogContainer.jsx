...
const EditBlogContainer = ({ blog, categories = [], tags: existingTags = [], selectedTags = [] }) => {
    ...
    const onSubmit = (data) => {
        const formData = {
            ...
            featured_image: data.featured_image ? data.featured_image?.file : blog.featured_image, // Handle file upload
        };
        router.post(route('blogs.update', { blog_slug: blog.slug }), formData, {
            onSuccess: () => {
                setNewTag('');
            },
            onError: (errors) => {
            ...
            <div className="mx-auto flex max-w-7xl gap-6">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="flex items-center justify-between rounded-lg bg-white p-6">
                        <h1 className="text-2xl font-medium text-gray-900">Editing blog</h1>
                ...
                <div className="w-96 space-y-6">
                    ...
                    >
                        <>
                            ...
                            {blog.featured_image && (
                                <div className="mb-4">
                                    <p className="mb-2 text-sm text-gray-600">Current featured image:</p>
                                    <img
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, value, ref } }) => (
                                    <FileUploadField.DragAndDrop
                                        control={control}
                                        text={blog.featured_image ? 'Upload New Image' : 'Upload Image'}
                    ...
                    <Field className="space-y-3" error={errors.tags} label="Tags" labelClassName={'text-gray-700 font-medium text-xl'}>
                        <div className="rounded-lg bg-white p-4">
                            <h3 className="mb-6 text-lg font-medium text-gray-900">Manage tags</h3>
                            <p className="mb-3 text-sm text-gray-700">Add or remove tags to help categorize your blog post.</p>
