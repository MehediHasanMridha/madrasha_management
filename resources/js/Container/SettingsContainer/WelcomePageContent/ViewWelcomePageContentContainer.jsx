    ...
    return (
        <ModalUI
            ...
            footer={() => (
                <button
                    onClick={onClose}
                    className="cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
                >
                    Close
                </button>
            )}
                ...
                <FieldSet label="Content Details" labelClassName="text-[16px] font-bold" hr={true}>
                    ...
                    {content.data && Object.keys(content.data).length > 0 && (
                        <Field label={'Additional Data'} className="md:col-span-2">
                            <div className="rounded-[8px] border-[1px] border-[#AFAFAF] bg-gray-50 px-[16px] py-[12px]">
                                <pre className="overflow-auto text-sm whitespace-pre-wrap text-gray-600">{JSON.stringify(content.data, null, 2)}</pre>
                            </div>
                        </Field>
                    )}
                </FieldSet>
